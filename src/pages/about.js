  ...
  <Layout>
    ...
    <div className="section">
      ...
      <p>
        ...
        science within that career pathway. The role of the KCSC is not to
        create more scientists, but to support development of well-rounded and
    ...
    <div className="slanted-up-green">
      ...
      <p>
        The student generated display/hands on activity will be shared with the
        public. Students will gain valuable experience and skills working with
        the professionals, learning about the career, developing the
        displays/hands on activities and learning about science.KCSC also plans
        to offer student led activities on a wide array of science topics for
        other students, the community and visitors.
      </p>
    </div>
    <div className="section">
      <div className="pic intern-pic-right"></div>
    ...
    <div>h1 a section about the team!</div>
    <div>A Bunch of resources about us</div>
  </Layout>
)
